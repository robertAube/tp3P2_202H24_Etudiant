...
public class ColonneCartes implements Serializable {
     ...
     */
    private boolean colonneADessiner;
    ...
    /**
     * Retourne <b>true</b> si la colonne est vide
     *
    ...
    /**
     * Retourne <b>true</b> si la colonne est à dessiner parce qu'il y a eu un changement
     * dans la colonne.
     *
     ...
     *
     * @param idxColonneADessiner <b>true</b> pour indiquer que la colonne doit être redessinée.
     *                            <b>false</b> pour indiquer que la colonne n'a pas à être dessinée.
     */
     ...
     *
     * @return le nombre de cartes dans la colonne.
     */
     ...
     * Attention : la Pile (ou le contenu de la colonne) ne doit pas être modifiée
     * suite à cette méthode.
     *
     * @return une liste qui donne le contenu de la colonne.
     */
